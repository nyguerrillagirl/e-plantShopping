...
function ProductList({ onHomeClick }) {
  ...
  // Extracting category names for display
  const plant_category_names = [
  ...
  // Functions to obtain plant category array
  const getPlantsByCategory = (category) => {
    const categoryData = plantsArray.find((item) => item.category === category);
    return categoryData ? categoryData.plants : [];
  };
    ...
    <a href="#" onClick={handleCartClick}>
      ...
      {!showCart ? (
        <div className="product-grid">
          {/* Loop through plant_category_names and print the plant categories */}
          {plant_category_names.map((category) => (
            <div key={category}>
              ...
              <div className="product-list">
                {getPlantsByCategory(category).map((plant) => (
                  <div key={plant.name} className="product-card">
                    ...
                    <button
                      className={`product-button ${isPlantInCart(plant) ? "added-to-cart" : ""}`}
                      disabled={isPlantInCart(plant)} // Disable the button if the plant is already in the cart
